...
var getDefaultProps = function getDefaultProps(props) {
  ...
  var _iterator = _rollupPluginBabelHelpers.createForOfIteratorHelper(keys),
      _step;
    ...
    value: function _onFrame() {
      ...
      if (active && !this._started || changed && !this._started) {
        ...
        reactSpringShared_esm.flush(onStart, function (_ref8) {
          var _ref9 = _rollupPluginBabelHelpers.slicedToArray(_ref8, 2),
              onStart = _ref9[0],
              result = _ref9[1];
      ...
      if (changed && onChange.size) {
        reactSpringShared_esm.flush(onChange, function (_ref10) {
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (asyncTo) {
              ...
              reactSpringShared_esm.each(BATCHED_EVENTS, function (key) {
...
function getSprings(ctrl, props) {
  ...
  if (props) {
    reactSpringShared_esm.each(reactSpringShared_esm.toArray(props), function (props) {
...
function prepareSprings(springs, props, create) {
  if (props.keys) {
    reactSpringShared_esm.each(props.keys, function (key) {
...
function useSpring(props, deps) {
  ...
  var _useSprings = useSprings(1, isFn ? props : [props], isFn ? deps || [] : deps),
      _useSprings2 = _rollupPluginBabelHelpers.slicedToArray(_useSprings, 2),
      _useSprings2$ = _rollupPluginBabelHelpers.slicedToArray(_useSprings2[0], 1),
...
var Interpolation = /*#__PURE__*/function (_FrameValue2) {
  ...
  _rollupPluginBabelHelpers.createClass(Interpolation, [{
    ...
    value: function _attach() {
      ...
      reactSpringShared_esm.each(reactSpringShared_esm.toArray(this.source), function (source) {
        if (reactSpringShared_esm.hasFluidValue(source)) {
          reactSpringShared_esm.addFluidObserver(source, _this18);
        }
    ...
    value: function _detach() {
      ...
      reactSpringShared_esm.each(reactSpringShared_esm.toArray(this.source), function (source) {
        if (reactSpringShared_esm.hasFluidValue(source)) {
          reactSpringShared_esm.removeFluidObserver(source, _this19);
        }
      });
    ...
    value: function eventObserved(event) {
      if (event.type == 'change') {
        ...
        this.priority = reactSpringShared_esm.toArray(this.source).reduce(function (highest, parent) {
