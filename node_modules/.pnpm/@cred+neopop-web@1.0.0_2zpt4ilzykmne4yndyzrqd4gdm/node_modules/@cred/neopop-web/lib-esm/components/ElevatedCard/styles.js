...
var CardFace = styled.div.withConfig({
  displayName: "styles__CardFace",
  componentId: "sc-1ryjlf6-0"
})(["position:relative;background-color:", ";z-index:1;width:100%;margin:0 ", "px ", "px 0;"], function (_ref) {
  var backgroundColor = _ref.backgroundColor;
  return backgroundColor !== null && backgroundColor !== void 0 ? backgroundColor : 'transparent';
}, EDGEWIDTH, EDGEWIDTH);
var CardEdge = styled.div.withConfig({
  displayName: "styles__CardEdge",
  componentId: "sc-1ryjlf6-1"
})(["position:absolute;transform-origin:0% 0%;transition:transform ", "s ease;&.right{height:calc(100% - ", "px);width:", "px;transform:translate3d(0px,0px,0px) skewY(", "deg);right:0px;background-color:", ";top:0px;}&.bottom{width:calc(100% - ", "px);height:", "px;transform:translate3d(0px,0px,0px) skewX(", "deg);bottom:0px;left:0px;background-color:", ";}"], EDGEWIDTH / 100, EDGEWIDTH, EDGEWIDTH, SKEW_ANGLE, function (_ref2) {
...
})(["display:", ";overflow:hidden;user-select:none;width:100%;--webkit-user-select:none;position:relative;"], function (_ref4) {
  var fullWidth = _ref4.fullWidth;
  return fullWidth ? 'block' : 'inline-flex';
});

export { CardContainer, CardEdge, CardFace };
