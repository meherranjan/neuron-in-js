...
export declare enum NeoPopElevationDirections {
    br = "bottom-right",
    tr = "top-right",
    bl = "bottom-left",
    tl = "top-left",
...
export declare type ButtonKinds = 'flat' | 'elevated' | 'link';
export declare type ButtonSizes = 'big' | 'medium' | 'small';
export declare type ButtonModes = 'dark' | 'light';
