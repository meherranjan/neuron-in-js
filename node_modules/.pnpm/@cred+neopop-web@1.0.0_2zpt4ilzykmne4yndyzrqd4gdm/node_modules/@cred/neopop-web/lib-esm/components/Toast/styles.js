...
var showUp = function showUp(autoCloseTime) {
  return css(["@keyframes showup{0%{transform:translateY(-120%);}", "{transform:translateX(0);}90%{transform:translateX(0);}100%{transform:translateY(-120%);}}"], "".concat(20000 / autoCloseTime || 3000, "%"));
};

var ToastItem = styled.div.withConfig({
  displayName: "styles__ToastItem",
  componentId: "sc-k3rejn-0"
})(["", ";display:flex;align-items:flex-start;border-radius:", ";background-color:", ";padding:15px;margin:", ";margin-top:env(safe-area-inset-top);margin-top:constant(safe-area-inset-top);width:", ";position:fixed;top:0;left:0;animation:", ";animation-fill-mode:forwards;z-index:1001;"], function (_ref) {
